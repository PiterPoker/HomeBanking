...
{
    public class RenameFamilyCommandValidator : AbstractValidator<RenameFamilyCommand>
    {
        public RenameFamilyCommandValidator(ILogger<RenameFamilyCommandValidator> logger)
        {
